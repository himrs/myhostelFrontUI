...
const footerLinks = {
  company: [
    ...
    { label: "List Your Hostel", href: "/list-hostel" },
    { label: "Jobs", href: "/jobs" },
    { label: "Accommodations", href: "/accommodation" },
  ],
  support: [
    { label: "Contact Us", href: "/contact" },
    { label: "Request Accommodation", href: "/accommodation" },
  ...
  cities: [
    { label: "Lahore", href: "/?location=Lahore#search" },
    { label: "Karachi", href: "/?location=Karachi#search" },
    { label: "Islamabad", href: "/?location=Islamabad#search" },
    { label: "Rawalpindi", href: "/?location=Rawalpindi#search" },
  ],
}
